...
public class Contact {
    ...
    public String email;
    public int[] birthday;
    public HashMap<String,Boolean> restrictions_map, cuisines_map;
    public ArrayList<String> restrictions, cuisines;
    public int weight;
    ...
    public void loadRMap(HashMap<String,Boolean> map){
        restrictions_map = new HashMap<>();
        restrictions_map = map;
    }

    public void loadCMap(HashMap<String,Boolean> map){
        cuisines_map = new HashMap<>();
        cuisines_map = map;
    }

    public void loadRestrictions(ArrayList<String> list){
        restrictions = new ArrayList<>();
        restrictions = list;
    }

    public void loadCuisines(ArrayList<String> list){
